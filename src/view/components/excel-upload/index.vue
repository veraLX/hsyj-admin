<template>
    <div>
        <iframe ref="iframe" @load="finish" src="http://hsyj.100eduonline.com/static/images/admin/excelUpLoad/import.html" height="120" width="100%" style="border: none;overflow:hidden"/>
